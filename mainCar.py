...
mydb = mysql.connector.connect(host = "localhost", user = "root", passwd = "Dvg@5321", database = "car", autocommit=True)
...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        #self.Active.setStyleSheet("background-color: #85556F")#red
        #self.Active.setStyleSheet("background-color: #C9BBCF")#green
        def xd():
        ...
        def entry():
            ...
            try:
                ...
                if slots[0] == True:
                    self.s1.setStyleSheet("background-color: #B7D3DF")
                
                if slots[1] == True:
                    self.s2.setStyleSheet("background-color: #B7D3DF")
                
                if slots[2] == True:
                    self.s3.setStyleSheet("background-color: #B7D3DF")
                
                if slots[3] == True:
                    self.s4.setStyleSheet("background-color: #B7D3DF")
                
                if slots[4] == True:
                    self.s5.setStyleSheet("background-color: #B7D3DF")
                
                if slots[5] == True:
                    self.s6.setStyleSheet("background-color: #B7D3DF")

                if slots[6] == True:
                    self.s7.setStyleSheet("background-color: #B7D3DF")
                
                if slots[7] == True:
                    self.s8.setStyleSheet("background-color: #B7D3DF")
                
                if slots[8] == True:
                    self.s9.setStyleSheet("background-color: #B7D3DF")
                
                if slots[9] == True:
                    self.s10.setStyleSheet("background-color: #B7D3DF")
                
                if slots[10] == True:
                    self.s11.setStyleSheet("background-color: #B7D3DF")

                if slots[11] == True:
                    self.s12.setStyleSheet("background-color: #B7D3DF")
                
                if slots[12] == True:
                    self.s13.setStyleSheet("background-color: #B7D3DF")
                
                if slots[13] == True:
                    self.s14.setStyleSheet("background-color: #B7D3DF")
                
                if slots[14] == True:
                    self.s15.setStyleSheet("background-color: #B7D3DF")
                
                if slots[15] == True:
                    self.s16.setStyleSheet("background-color: #B7D3DF")
